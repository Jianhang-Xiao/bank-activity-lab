...
class StockMetrics(StockData): #interitance in stockData code allows the "StockMetrics" class to reuse the code and functionality of the "stockdata" class
    ...
    def average01(self):
        ...
        for row in self.data:
            ...
            x=stats.mean(new_row) #calculate the mean of the values in the new_row list
            averages.append(round(x,3)) #round the result to three decimal places, and then append the rounded mean to the averages list
        return averages
